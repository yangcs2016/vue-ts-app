<template>
  <div class="login">
    <LoginHeader>
      <el-form :rules="rules" ref="ruleForm" :model="ruleForm" label-position="left" 
      label-width="0px" slot="container">
        <div class="title">
          <h3>账号密码登录</h3>
        </div>
        <!--username-->
        ...
        <!--登录button-->
        <el-form-item>
          <el-button @click.native.prevent="handleSubmit" :loading="isLogin" type="primary" style="width:100%;">登录</el-button>
        </el-form-item>
